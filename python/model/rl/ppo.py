...
from rl.jass_env import JassEnv, JASSFORMER_MODEL_PATH
...
if __name__ == "__main__":
    ...
    obs = torch.zeros((args.num_steps, args.num_envs) + envs.single_observation_space.shape,dtype=torch.int64).to(device)
